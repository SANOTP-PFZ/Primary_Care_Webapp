...
st.set_page_config(page_title="Paxlovid QoQ Report", layout="wide", initial_sidebar_state="collapsed")
...
<div class="top-ribbon">
    {logo_html}
    <span class="title">Paxlovid QoQ Report</span>
</div>
""", unsafe_allow_html=True)
